...
import org.opensearch.security.signals.actions.watch.activate_deactivate.DeActivateWatchRequest;
import org.opensearch.security.signals.actions.watch.activate_deactivate.DeActivateWatchResponse;
...
public class DeActivateWatchAction extends SignalsBaseRestHandler implements TenantAwareRestHandler {
    ...
    protected final RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> {
            ...
            client.execute(org.opensearch.security.signals.actions.watch.activate_deactivate.DeActivateWatchAction.INSTANCE,
